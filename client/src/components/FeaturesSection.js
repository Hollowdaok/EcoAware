...
const features = [
  ...
  { title: "Еко-ігри", desc: "Інтерактивні міні-ігри для розвитку навичок екосвідомого життя.", icon: "🎮" },
  { title: "Тести", desc: "Перевірте свої знання, пройдіть тести та отримайте персональні рекомендації.", icon: "📝" },
  { title: "Досягнення", desc: "Заробляйте бали та отримуйте віртуальні нагороди.", icon: "🏆" },
];
